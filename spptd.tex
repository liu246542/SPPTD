...
In some specific applications such as the sparse mobile crowdsensing, workers can only contribute sensory data on small part of sensing tasks, which implies that the information of which tasks are completed by a worker should also be protected.
