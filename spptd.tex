...
\begin{figure}[htbp]
  ...
  \subfloat[Accuracy Comparison with CATD]{ 
    \label{fig:rmse1}
    \includegraphics[width=0.48\linewidth]{figures/rmse1.eps}}
  \subfloat[The Impact of Different Sparsity]{ 
    \label{fig:rmse2} 
    \includegraphics[width=0.48\linewidth]{figures/rmse2.eps}} 
...
\begin{figure}[!ht]
  ...
  \subfloat[$K = 10 $]{ 
    \label{fig:comp1}
    \includegraphics[width=0.49\linewidth]{figures/time_obj.eps}}
  \subfloat[$M = 20$]{ 
    \label{fig:comp2} 
    \includegraphics[width=0.49\linewidth]{figures/time_work.eps}} 
...
\bibitem{xue_two-cloud_2017}
K.~Xue, S.~Li, J.~Hong, Y.~Xue, N.~Yu, and P.~Hong, ``Two-cloud secure database
 for numeric-related SQL range queries with privacy preserving,'' \emph{IEEE
  Transactions on Information Forensics and Security}, vol.~12, no.~7, pp. 1596--1608,
  Mar. 2017.
