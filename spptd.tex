...
\author{\IEEEauthorblockN{Feng Liu, Bin Zhu, Shaoxian Yuan, Jian Li, Kaiping Xue$^\dag$}
...
To address this challenge, an effective method called truth discovery~\cite{li_resolving_2014,li_confidence-aware_2014,li_conflicts_2016} is proposed, where the general principle is to calculate each worker's reliability degree (usually referred to as {\em weight}) before estimating the truths.
...
\begin{figure}[htbp]
  ...
  \subfloat[Accuracy Comparison with CATD]{ 
    \label{fig:rmse1}
    \includegraphics[width=0.48\linewidth]{figures/rmse1.pdf}}
  \subfloat[The Impact of Different Sparsity]{ 
    \label{fig:rmse2} 
    \includegraphics[width=0.48\linewidth]{figures/rmse2.pdf}} 
...
\begin{figure}[!ht]
  ...
  \subfloat[$K = 10 $]{ 
    \label{fig:comp1}
    \includegraphics[width=0.49\linewidth]{figures/time_obj.pdf}}
  \subfloat[$M = 20$]{ 
    \label{fig:comp2} 
    \includegraphics[width=0.49\linewidth]{figures/time_work.pdf}} 
...
\bibitem{li_resolving_2014}
Q.~Li, Y.~Li, J.~Gao, B.~Zhao, W.~Fan, and J.~Han, ``Resolving conflicts in
  heterogeneous data by truth discovery and source reliability estimation,'' in
  \emph{Proceedings of the 2014 {International} {Conference} on {Management} of
  {Data} (SIGMOD)}.\hskip 1em plus 0.5em minus 0.4em\relax ACM, Jun. 2014, pp.
  1187--1198.

\bibitem{li_confidence-aware_2014}
Q.~Li, Y.~Li, J.~Gao, L.~Su, B.~Zhao, M.~Demirbas, W.~Fan, and J.~Han, ``A
  confidence-aware approach for truth discovery on long-tail data,''
  \emph{Proceedings of the VLDB Endowment}, vol.~8, no.~4, pp. 425--436, Dec.
  2014.

\bibitem{li_conflicts_2016}
Y.~Li, Q.~Li, J.~Gao, L.~Su, B.~Zhao, W.~Fan, and J.~Han, ``Conflicts to
  harmony: {A} framework for resolving conflicts in heterogeneous data by truth
  discovery,'' \emph{IEEE Transactions on Knowledge and Data Engineering},
  vol.~28, no.~8, pp. 1986--1999, Aug. 2016.

\bibitem{miao_cloud-enabled_2015}
C.~Miao, W.~Jiang, L.~Su, Y.~Li, S.~Guo, Z.~Qin, H.~Xiao, J.~Gao, and K.~Ren,
  ``Cloud-enabled privacy-preserving truth discovery in crowd sensing
  systems,'' in \emph{Proceedings of the 13th {ACM} {Conference} on {Embedded}
  {Networked} {Sensor} {Systems} (SenSys)}.\hskip 1em plus 0.5em minus
  0.4em\relax ACM, Nov. 2015, pp. 183--196.

\bibitem{xu_efficient_2019}
G.~Xu, H.~Li, S.~Liu, M.~Wen, and R.~Lu, ``Efficient and privacy-preserving
  truth discovery in mobile crowd sensing systems,'' \emph{IEEE Transactions on
  Vehicular Technology}, vol.~68, no.~4, pp. 3854--3865, Jan. 2019.

\bibitem{miao_lightweight_2017}
C.~Miao, L.~Su, W.~Jiang, Y.~Li, and M.~Tian, ``A lightweight
  privacy-preserving truth discovery framework for mobile crowd sensing
  systems,'' in \emph{Proceedings of the 2017 {IEEE} {Conference} on
  {Communications} (Infocom)}. \hskip 1em plus 0.5em minus 0.4em\relax IEEE, May 2017, pp. 1--9.

\bibitem{zhang_reliable_2019}
C.~Zhang, L.~Zhu, C.~Xu, X.~Liu, and K.~Sharif, ``Reliable and
  privacy-preserving truth discovery for mobile crowdsensing systems,''
  \emph{IEEE Transactions on Dependable and Secure Computing}, vol.~18, no.~3,
   pp. 1245--1260, May 2019.

\bibitem{xue_inpptd_2020}
K.~Xue, B.~Zhu, Q.~Yang, N.~Gai, D.~S.~L. Wei, and N.~Yu, ``{InPPTD}: An
  lightweight incentive-based privacy-preserving truth discovery for crowd
  sensing systems,'' \emph{IEEE Internet of Things Journal}, vol.~8, no.~6,
   pp. 4305--4316, Oct. 2020.

\bibitem{tang_achieving_2021}
J.~Tang, S.~Fu, X.~Liu, Y.~Luo, and M.~Xu, ``Achieving privacy-preserving and
  lightweight truth discovery in mobile crowdsensing,'' \emph{IEEE Transactions
  on Knowledge and Data Engineering}, Early Access, 2021.

\bibitem{wang_sparse_2016}
L.~Wang, D.~Zhang, Y.~Wang, C.~Chen, X.~Han, and A.~M'hamed, ``Sparse mobile
  crowdsensing: Challenges and opportunities,'' \emph{IEEE Communications
  Magazine}, vol.~54, no.~7, pp. 161--167, Jul. 2016.

\bibitem{wang_energy_2018}
J.~Wang, Y.~Wang, D.~Zhang, and S.~Helal, ``Energy saving techniques in mobile
  crowd sensing: Current state and future opportunities,'' \emph{IEEE
  Communications Magazine}, vol.~56, no.~5, pp. 164--169, May 2018.

\bibitem{zheng_learning_2018}
Y.~Zheng, H.~Duan, and C.~Wang, ``Learning the truth privately and confidently:
  Encrypted confidence-aware truth discovery in mobile crowdsensing,''
  \emph{IEEE Transactions on Information Forensics and Security}, vol.~13,
  no.~10, pp. 2475--2489, Mar. 2018.

\bibitem{wang_sparse_2020}
L.~Wang, D.~Zhang, D.~Yang, B.~Y. Lim, X.~Han, and X.~Ma, ``Sparse mobile
  crowdsensing with differential and distortion location privacy,'' \emph{IEEE
  Transactions on Information Forensics and Security}, vol.~15, pp. 2735--2749,
  Feb. 2020.

\bibitem{paillier_public-key_1999}
P.~Paillier, ``Public-key cryptosystems based on composite degree residuosity
  classes,'' in \emph{Proceedings of the 1999 {International} {Conference} on
  the {Theory} and {Applications} of {Cryptographic} {Techniques}}.\hskip 1em
  plus 0.5em minus 0.4em\relax Springer, Apr. 1999, pp. 223--238.

\bibitem{PythonPaillier}
``Python paillier library,'' \url{https://github.com/data61/python-paillier}.
